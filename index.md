...
My research focuses on the intersection of political methodology and American politics, where I develop measures of collective political preferences and examine their substantive implications for public opinion polarization, systems of preferences in legislative and mass politics, and the electoral success of minority groups. A recurring theme in my research is the lack of conceptual clarity and reductive operationalization of these phenomena in current work. I develop rigorous measurement frameworks rooted in theoretically motivated definitions, which enable the revision of established substantive conclusions when existing measures obscure important patterns.

In public opinion, I develop new measures of opinion divergence using optimal transport and examine how policy disagreement can contribute to mass polarization independently of partisanship. My work on collective systems of preferences uses an extended latent factor-network model to identify collective legislative voting patterns that are obscured by conventional latent-factor models, revealing that within-party factions and cross-party coalitions constitute distinct forms of legislative behavior. In electoral politics, I study how electoral systems shape opportunities for representation, including measuring group electoral competitiveness and using simulation methods to study the importance of within-group coordination in minority-group representation.
 ...
 *Job Market Paper*. Hane Lee. "[Reconsidering the Necessity of Partisanship in Mass Polarization](assets/files/hanelee_jmp.pdf)".
 <details>
...
<br>
 Hane Lee and Michael Sobel (2026). "[Measuring Public Opinion: “The Wasserstein Bipolarization Index”, with Application to Cross-National Attitudes Toward Mandatory Vaccination for COVID-19.](https://projecteuclid.org/journals/annals-of-applied-statistics/volume-20/issue-2/Measuring-public-opinion--The-Wasserstein-bipolarization-index-with-application/10.1214/26-AOAS2162.short)". *Annals of Applied Statistics* 20 (2) pp. 1719–1735. https://doi.org/10.1214/26-AOAS2162
...
<br>
 *Working paper*. Hane Lee and Andrew Davison. "[Recovering Collective Structure in Congressional Voting: A Fused Latent Factor and Network Approach](assets/files/M2PL_Ising.pdf)".
 <details>
  <summary>Abstract</summary>
